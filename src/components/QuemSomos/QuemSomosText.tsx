      ...
      <>
        <S.QuemSomosSection>
            <div className="text">
                ...
                <h2 className="text2">Somos uma startup em expansão na área da saúde como foco na humanização e agilidades na formalização de prontuários digitais de pacientes objetivando a redução de espera no atendimento clínico em hospitais, clínicas e/ou laboratórios otimizando assim o tempo no recebimento, armazenamento e leitura de dados do paciente em seu prontuário online.
                </h2>
